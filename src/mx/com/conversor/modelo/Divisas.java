...
public class Divisas extends DiseñoGlobal implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.botonCanje) {
			try { 
				...
				default:
					JOptionPane.showMessageDialog(null, "Finalizando programa", "Conversor",JOptionPane.INFORMATION_MESSAGE, icon);
					break;
				}
